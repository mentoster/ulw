...
This repository is a modified ULW port and extension of portions of the
OpenCode/oh-my-openagent `ulw-plan` skill. The inspected source baseline was
commit `ed0241d1a`, particularly:

```text
packages/shared-skills/skills/ulw-plan/
```

The port changes the artifact namespace, workflow ownership, review gates,
state model, deployment mechanism, and command surface. It is not an official
OpenCode or oh-my-openagent distribution.

The new ULW CLI and original additions are licensed under the MIT
License in `LICENSE.md`. Adapted upstream portions remain subject to the
upstream terms reproduced below.
...
and this license will automatically terminate. If the licensor provides you
with a notice of your violation, and you cease all violation of this license no
later than 30 days after you receive that notice, this license will be
reinstated retroactively. However, if you violate these terms after such
reinstatement, any additional violation will cause this license to terminate
